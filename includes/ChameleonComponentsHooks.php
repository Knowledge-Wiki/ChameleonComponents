...
class ChameleonComponentsHooks {

	public static function onRegistration() {
		ChameleonComponents::initTheme();
	}
	...
	public static function onParserFirstCallInit( $parser ) {
		$parser->setFunctionHook( 'noparse', [ ChameleonComponents::class, 'parserFunctioNoparse' ] );
	}
	...
	public static function onBeforePageDisplay( OutputPage $outputPage, Skin $skin ) {
		...
		$outputPage->addModules( [ "ext.ChameleonComponents.$theme" ] );
	}
}
